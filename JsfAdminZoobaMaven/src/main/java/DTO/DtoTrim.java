...
public class DtoTrim {
    ...
    public String getModel_height_mm() {
        return model_height_mm;
    }

    public void setModel_height_mm(String model_height_mm) {
    ...
    public String getModel_fuel_cap_l() {
        return model_fuel_cap_l;
    }

    public void setModel_fuel_cap_l(String model_fuel_cap_l) {
